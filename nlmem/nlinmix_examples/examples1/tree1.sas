**options mprint;
options nocenter ls=72 ps=77;

/*
tree1.sas illustrates how does switch= argument work
          In previous version of NLINMIX (May 2000) switch did not work 
             properly 
          Note that NLINMIX does not converge, because maxit=2
